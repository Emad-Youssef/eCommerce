<div class="btn-group">
    ...
    <div class="dropdown-menu" role="menu" x-placement="bottom-start"
        ...
        <a href="{{route('admin.mainCategory.edit',$category_id)}}" class="dropdown-item btn btn-outline-primary"><i
                class="la la-edit"></i> @lang('site.edit')</a>
        <a data-route="{{ route('admin.mainCategory.destroy',$category_id) }}"
