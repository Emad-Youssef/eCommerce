<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <!-- options -->
        <li class=" nav-item"><a href="#"><i class="la la-pie-chart"></i><span class="menu-title" data-i18n="nav.templates.main">{{ __('site.options') }}</span></a>
          <ul class="menu-content">
            <li class="{{Request::is('*/options')?'active':''}}"><a class="menu-item" href="{{ route('admin.options.index') }}">{{ __('site.show_options') }}</a>
            </li>
            <li class="{{Request::is('*/options/create')?'active':''}}"><a class="menu-item" href="{{ route('admin.options.create') }}" data-i18n="nav.templates.vert.compact_menu">{{ __('site.add_option') }}</a>
            </li>
