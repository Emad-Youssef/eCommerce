...
<fieldset data-pos="form-file-upload-t-2">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <input type="number" id="price" class="form-control border-msg" name="price" value="{{ isset($product)?$product->price:'' }}">
        ...
        <div class="col-md-6">
            ...
            <input type="number" id="selling_price" class="form-control border-msg" name="selling_price" value="{{ isset($product)?$product->selling_price:'' }}">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <input type="number" id="special_price" class="form-control border-msg" name="special_price" value="{{ isset($product)?$product->special_price:'' }}">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="date" name="special_price_start" class="form-control" id="date1" value="{{ isset($product)?$product->special_price_start:'' }}">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="date" name="special_price_end" class="form-control" id="date2" value="{{ isset($product)?$product->special_price_end:'' }}">
