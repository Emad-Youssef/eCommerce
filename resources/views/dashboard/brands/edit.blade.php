                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.brands.index')}}">{{__('site.brands')}}</a>
                            </li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <form id="form-ajax" class="form" data-action="{{ route('admin.brands.update',$brand->id) }}" method="POST"
